...
public class Egresados extends Alumnos {
    ...
    public Egresados(String Nombre, String Apellidos, String Genero, int Edad, long Matricula, String Grupo, String Carrera) {
    ...
    public Egresados agregarAlumnoEgresado() {
        ...
        return new Egresados(Nombre, Apellidos, Genero, Edad, Matricula, Grupo, Carrera);
    }

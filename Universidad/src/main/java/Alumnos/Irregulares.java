...
public class Irregulares extends Alumnos {
    ...
    public Irregulares(String Nombre, String Apellidos, String Genero, int Edad, long Matricula, String Grupo, String Carrera, int MatReprobadas) {
    ...
    public Irregulares agregarAlumnoIrregular() {
        ...
        return new Irregulares(Nombre, Apellidos, Genero, Edad, Matricula, Grupo, Carrera, MatReprobadas);
    }

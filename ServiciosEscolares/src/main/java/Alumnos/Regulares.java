...
public class Regulares extends Alumnos {
    ...
    public Regulares(String Nombre, String Apellidos,int Edad, String Genero , long Matricula, String Grupo, String Carrera) {
    ...
    public Regulares agregarAlumnoRegular() {
        ...
        return new Regulares(Nombre, Apellidos, Edad ,Genero, Matricula, Grupo, Carrera);
    }

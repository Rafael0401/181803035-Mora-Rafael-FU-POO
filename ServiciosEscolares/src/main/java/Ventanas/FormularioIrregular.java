 ...
 * @author Carlos
 */
public class FormularioIrregular extends javax.swing.JFrame {

    
    Archivo archivo = new Archivo();
    Irregulares alumnoIrregular;
    ...
    String genero;
    long matricula;
    int materiaReprobada;
    String carrera;
    String grupo;
    
    private final String irregulares = "Irregulares.txt";
    /**
     * Creates new form FormularioIrregular
     */
    public FormularioIrregular() {
        initComponents();
    ...
    private void initComponents() {
        ...
        MateriasReprobadas = new javax.swing.JTextField();
        ...
        jLabel1.setText("Registrar alumno irregular");
        ...
        jLabel10.setText("Materias Reprobadas");

        MateriasReprobadas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MateriasReprobadasActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(MateriasReprobadas, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(MateriasReprobadas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(8, 8, 8)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        if (this.nombreAlumno.getText().equals("") || this.Apellidos.getText().equals("") || this.Edad.getText().equals("") || this.Genero.getText().equals("") || this.Matricula.getText().equals("") || this.Carrera.getText().equals("") || this.Grupo.getText().equals("")||this.MateriasReprobadas.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Llene todos los datos");
        } else {
            archivo.crearArchivo(irregulares);
            ...
            this.materiaReprobada=Integer.parseInt(this.MateriasReprobadas.getText());
            alumnoIrregular = new Irregulares(nombre, apellidos, edad, genero, matricula, grupo, carrera, materiaReprobada);
            if (archivo.escribirAlumnoIrregular(alumnoIrregular)) {
                ...
                this.Grupo.setText("");
                this.MateriasReprobadas.setText("");
            } else {
    ...
    private void MateriasReprobadasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MateriasReprobadasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MateriasReprobadasActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioIrregular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormularioIrregular().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField MateriasReprobadas;

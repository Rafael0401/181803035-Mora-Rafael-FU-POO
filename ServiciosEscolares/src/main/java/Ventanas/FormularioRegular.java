 ...
 * @author Carlos
 */
public class FormularioRegular extends javax.swing.JFrame {

    Archivo archivo = new Archivo();
    Regulares alumnoRegular;
    ...
    String carrera;
    String grupo;
    private final String regulares = "Regulares.txt";

    public FormularioRegular() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registrar alumno regular");
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        if (this.nombreAlumno.getText().equals("") || this.Apellidos.getText().equals("") || this.Edad.getText().equals("") || this.Genero.getText().equals("") || this.Matricula.getText().equals("") || this.Carrera.getText().equals("") || this.Grupo.getText().equals("")) {
            ...
            archivo.crearArchivo(regulares);
            ...
            alumnoRegular = new Regulares(nombre, apellidos, edad, genero, matricula, grupo, carrera);
            if (archivo.escribirAlumnoRegular(alumnoRegular)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioRegular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormularioRegular().setVisible(true);
            }
        });
    }
